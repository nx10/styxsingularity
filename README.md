...
> `styxsingularity` (the Singularity/Apptainer runner) is now developed in the
...
> The PyPI package `styxsingularity` continues to be published from the new location.
